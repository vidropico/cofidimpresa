							...
							<c:forEach var="tipoSocieta" items="${tipoSocietaList}">
								<c:choose>
									<c:when test="${sociData.idTipoSocieta eq tipoSocieta.id}">
										<form:option label="${tipoSocieta.descrizione}"
											value="${tipoSocieta.id}" selected="true" />
									</c:when>
									<c:otherwise>
										<form:option label="${tipoSocieta.descrizione}"
											value="${tipoSocieta.id}" />
									</c:otherwise>
								</c:choose>
							</c:forEach>
						</form:select>
				...
				<div class="row" style="margin-bottom: 10px;">
							...
							<c:forEach var="settoreImpresa" items="${settoreImpresaList}">
								<c:choose>
									<c:when
										...
										<form:option label="${settoreImpresa.descrizione}"
											value="${settoreImpresa.id}" selected="true" />
									</c:when>
									<c:otherwise>
										<form:option value="${settoreImpresa.id}"
					...
					<div class="col-sm-3">
						<form:input path="dataAttivita" value="${sociData.dataAttivita}"
							type="text" placeholder="Data Inizio Attività" />
				...
				<div class="row" style="margin-bottom: 10px;">
					...
					<div class="col-sm-3">
						<form:input path="capSedeLegale" value="${sociData.capSedeLegale}"
							type="text" placeholder="Cap Sede Legale" />
				...
				<div class="row" style="margin-bottom: 10px;">
					...
					<div class="col-sm-3">
						<form:input path="cittaAzienda" value="${sociData.cittaAzienda}"
							type="text" placeholder="Città Sede Azienda" />
					</div>
					<div class="col-sm-3">
						<form:input path="capAzienda" value="${sociData.capAzienda}"
							type="text" placeholder="Cap Sede Azienda" />
					</div>
					<div class="col-sm-3">
				...
				<div class="row" style="margin-bottom: 10px;">
					<div class="col-xs-5">
						<select name="from[]" id="search" class="form-control" size="8"
							multiple="multiple" style="width: 300px; height: 300px;">
					...
					<div class="col-xs-4"
						style="margin-top: 120px !important; width: 70px;">
